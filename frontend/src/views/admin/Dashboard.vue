        ...
        <div class="section-content">
          <div class="actions-grid">
            ...
            <div class="action-item" @click="goToReports">
              ...
              <div class="action-text">
                <div class="action-title">{{ $t('admin.dataReports') }}</div>
                <div class="action-desc">{{ $t('admin.viewDetailedStatistics') }}</div>
              </div>
            </div>
      ...
      <el-form :model="notificationForm" label-width="80px">
        ...
        <el-form-item :label="$t('admin.sendTarget')">
          <el-radio-group v-model="notificationForm.targetType">
            <el-radio label="all">{{ $t('admin.allUsers') }}</el-radio>
            <el-radio label="user">{{ $t('admin.specificUser') }}</el-radio>
          </el-radio-group>
        </el-form-item>
...
.stat-icon {
  ...
  &.questions { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
  &.categories { background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); }
  &.practices { background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); }
  &.accidents { background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); }
  &.score { background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); }
}
