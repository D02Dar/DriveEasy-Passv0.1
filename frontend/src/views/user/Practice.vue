          ...
          <div class="category-header">
            ...
            <div class="category-info">
              <h3 class="category-name">
                {{ category.id === 1 ? $t('practice.allQuestions') : category.name }}
              </h3>
              <p class="category-description">
                {{ category.id === 1 ? $t('practice.allQuestionsDesc') : category.description }}
              </p>
            </div>
          </div>
      ...
      <el-form :model="practiceSettings" label-width="100px">
        ...
        <el-form-item :label="$t('practice.practiceMode')">
          <el-radio-group v-model="practiceSettings.mode">
            <el-radio label="practice">{{ $t('practice.practiceModeName') }}</el-radio>
            <el-radio label="exam">{{ $t('practice.examModeName') }}</el-radio>
          </el-radio-group>
        </el-form-item>
